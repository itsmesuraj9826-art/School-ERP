...
class SchoolConfig(db.Model):
    ...
    doc_id_color          = db.Column(db.String(20),  default='#1565c0')
    doc_principal_name    = db.Column(db.String(150), default='')
    doc_principal_title   = db.Column(db.String(100), default='Principal')
    doc_exam_controller   = db.Column(db.String(150), default='')
    doc_exam_controller_title = db.Column(db.String(100), default='Controller of Examinations')
    doc_bonafide_text     = db.Column(db.Text, default='')
    doc_character_text    = db.Column(db.Text, default='')
    doc_admit_instructions= db.Column(db.Text, default='Candidates must bring this admit card to every examination. Mobile phones and electronic devices are strictly prohibited in the exam hall. Report 15 minutes before the exam start time.')
